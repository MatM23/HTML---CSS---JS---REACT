...
function Suggestions() {
    ...
    const nextSug = () => {
        if(to != products.length){
            ...
            alert("Límite de sugerencias alcanzado");
        }
    }
    const prevSug = () => {
        if(from > 0) {
    ...
    <div className={styles["sales-block"]}>
          <div className={styles["sales-title"]}>
          <img src="/chevron-left-solid-60.png" style={{cursor: "pointer"}} onClick={prevSug} />
            <h2>Productos relacionados</h2>
            <img src="/chevron-right-solid-60.png" style={{cursor: "pointer"}} onClick={nextSug} />
          </div>
